...
- Upholding responsibility toward society and stakeholders
...
- Risk management is crucial for current business operations undergoing continuous change. It ensures ThaiBev can achieve both short-term and long-term objectives, reducing losses and damages to an acceptable level and creating business opportunities to enhance competitiveness and growth.
...
- **Organizational Goals**: ThaiBev aims to be admired and sustainable, with a compensation philosophy that adapts to various employee levels and reflects recruitment situations in each country.
...
- **Safety Maintenance**: ThaiBev requires that safety is maintained in all processes in accordance with the legal requirements for safety, occupational health, and the working environment. ThaiBev ensures that it also conforms to international standards and other regulations. This ensures that employees, business partners, contractors, and other stakeholders are provided the highest level of safety and preventive measures to mitigate risks related to work, accidents, injuries, and work-related illnesses.

- **Quality of Life and Health**: For better quality of life and to promote the good health of employees, the working environment and hygienic standards have been improved to benefit employees' physical and mental health.

- **Awareness and Education**: To raise awareness and encourage employees of all levels to recognize the seriousness of safety, occupational health, and the working environment, ThaiBev has continuously educated its employees through training and activities, as well as various types of communication programs.
...
- **Training Sessions**: ThaiBev organizes annual training sessions on work safety and emergency drills for employees, enhancing their understanding of safety roles and responsibilities.

- **Smile@Safety Week 2018**: Held at ThaiBev headquarters with over 1,000 employees. The event focused on promoting safety culture, accident reduction, and occupational health. Activities included safety symbols, life-saving demonstrations, and fire hazard management.

- **Commitment to Safety**: ThaiBev aims to improve safety practices according to the OHSAS 18001 standard. The company has been recognized for outstanding safety, occupational health, and working environment practices for several years.
...
- **Annual Health Checkups**: ThaiBev organizes annual health checkups for employees with tailored checkup programs based on risk factors and age groups. For example, electrocardiogram checkups for employees aged 35 years and older, and breast cancer screening for at-risk female employees. ThaiBev also provides preventive care, such as annual influenza vaccinations.

- **"Preparing All-Ages-Employees for Happiness after Retirement" Campaign**: This campaign served to both raise awareness and educate employees in their respective age groups. ThaiBev organized the "2 Talks 2 Tones" program, with the theme of "Enjoy Work, Live the Life" for younger employees. Another program was based on the theme of "Manage the Readiness and Happiness Before Retirement" and was conducted for employees in general. The event focused primarily on topics related to saving and spending, financial planning, and other beneficial information from ThaiBev and the public sector, as well as health care and mental health management. In each event, speakers and content were selected to suit the target audience. ThaiBev initiated the event for the first time in 2018 with over 300 participants and will continue the campaign next year.

- **"Day Care for ThaiBev Kids"**: This was piloted for the first time during the school holidays in April 2018 for employees’ children (kindergarten and elementary school) to spend quality time enjoying art activities and life-skills lessons. During these activities, children are taught to respect rules, be self-reliant, and to help, share, and live harmoniously with others. The activities were led by teachers who were responsible for daily activities and recreation.
...
- **ThaiBev Engages in Forest Conservation with the Huay Hong Krai Royal Development Study Center to Improve Quality of Life**  
  In Nan Pang, Nan Province. Check dams were constructed to conserve headwaters and protect ecosystems to conserve the watershed in Nan Province.
...
- **Love Water, Love Forest, Conserve the Land – Volunteers Plant Trees to Conserve Water**  
  Staff of Mongkolsamai Co., Ltd., joined a tree-planting activity with the Uttaradit Provincial Administration Organization and Pha Juk district TAO in Being Mai, Ban Dan, Mae Khaman, Lab-Jae, Uttaradit Province, to help rehabilitate the forest and watershed.
...
**5%**  
Reduction of water intensity by the year 2020 compared to 2014 as a base year
...
- **Expansion Plans**: ThaiBev aims to expand its Water Sustainability Assessment (WSA) to manage water risks across all factories. The Groundwater Sustainability Assessment (GSA) at the Beer Thip Brewery (1991) Co., Ltd. in Ayutthaya Province is expected to be completed by November 2018. Future assessments will include all factories in the spirit, beer, and non-alcoholic beverage product groups, as well as the food business.

- **Supplier Engagement**: ThaiBev is encouraging suppliers to join the Water Footprint Project, focusing on sugar mills, with at least one sugar producer expected to complete the project in 2019. Plans include inviting other key suppliers, such as bottle manufacturers, for integrated water stewardship throughout the supply chain.
...
3. **Recycling**
   - Supporting employees to participate in reducing waste
...
1. **Energy from biogas**: A by-product of beverage production. It can be used to substitute energy from fossil fuels and produce less GHG emissions. This reduces the company’s fuel costs: in 2018, the company was able to replace the use of fuel oil by 19.26 million liters, equal to a savings of 306.85 million baht.
...
# ThaiBev Waste Management Expansion Plans (2019)
...
## Timeline of Recycling Business Development

| Year       | Initiative                          | Description                                                                 |
|------------|-------------------------------------|-----------------------------------------------------------------------------|
| 2004-2015  | Start of Recycling Business         | Buying and retrieving used glass bottles for reusing and recycling.         |
| 2016       | Expansion of Recycling Business     | Buying glass cullet for production of glass bottles.                        |
| 2017       | Operational Efficiency              | Adoption of technology, mechanization, and standardization.                 |
| 2018       | The First Recycling Factory         | Establish the first recycling factory in Ayutthaya province.                |
| 2019       | Variety of Recycling Materials      | Extend service line to other packaging materials: PET plastic bottles, aluminum cans, corrugated paper. |
| 2020       | Sustainable Leader                  | In glass bottles and recycling industry.                                    |
...
- **Reduce**: Reduce the use of raw materials (sand) by **43,680 tons** in the bottle manufacturing process.
- **Recycle**: Cullet recycled in production processes totaling **108,256 tons**.
- **Reuse**: **1,490 million** glass bottles reused in the production process.
...
### Reduce
- Over **340 million** pieces of plastic reduced from banning cap seals, estimated at **65%** of total plastic bottles produced.

### Bio-Based Materials
- **30%** of materials used in plastic bottles is derived from plant sources.

### Time for Biodegradable Plastic Bags to Degrade
- **3 years** on average, **150 times less** than normal plastic bags.
...
- **Impact**: >340 million pieces of plastic reduced
...
- **Impact**: 30% of plastic component is derived from plants
...
- **Impact**: 2,400 tons of glass retrieved
...
ThaiBev has set a long-term target to achieve sustainable packaging management, considering the impact of products from design and development to post-consumption management.

### Strategies

#### Developing or Redesigning Product

- Consider the packaging's end-of-life, including the retrieval process for reuse or recycling.

#### Sourcing Packaging Materials

- Incorporate environmental considerations into packaging material selection, such as using recycled material.
- Collaborate with partners to create packaging innovations to minimize long-term environmental impacts.

#### Production

- Use technology to improve packaging production to increase resource efficiency, such as reducing waste from the production process.

#### Managing Post-consumption Packaging

- Establish purchasing centers in every region of Thailand to retrieve used packaging and scraps, including glass bottles, cullet, and corrugated cartons.
- Set targets to reuse packaging in packing and production processes.
- Encourage consumers and local communities to participate in post-consumption packaging management.

# Energy and Climate Change

- **Reducing the impacts of climate change** on ThaiBev’s value chain by supporting the development of technology and renewable energy programs, promoting energy conservation, and maximizing resource value.

- **Encouraging staff** to increase production efficiency, cut costs, and raise awareness of social and environmental responsibilities through projects like using renewable energy from solar cells and byproducts such as biogas from waste treatment for steam generation.

- **Implementing production processes** and management policies using the 3Rs principle – Reduce, Reuse, Recycle – starting from product design, managing the product value chain, and promoting employee awareness in their daily lives.

## ThaiBev's Framework for Climate Change Mitigation

### Strategy

- **Risk Management Process**: 
  - Across physical climate change and energy transition risks.
  - Innovation and business development opportunities from products/services enabling carbon savings.

- **Cross-Departmental Management**:
  - Managing various physical and transition risks/opportunities.
  - Elevating material issues to Board level for strategic management.

### Operational

- **Accurate Accounting**:
  - For all scope 1, 2, and 3 emissions, with full verification.
  - Product life-cycle emissions accounting.

- **GHG Reduction Targets**:
  - Across the organization (absolute, intensity), often through MAC curves.
  - Limit global temperature rise to well below 2 degrees Celsius and meet renewable energy targets.

- **Stakeholder Communication**:
  - Engaging with consumers, investors, business partners.
  - Working with policymakers and industry organizations to advance low carbon business frameworks.
...
|------|--------------------------|------------------------------|----------------------|
| 2014 | 4.54                     | 205.04                       | 250.53               |
| 2015 | 4.06                     | 191.84                       | 233.90               |
| 2016 | 3.78                     | 174.61                       | 213.39               |
| 2017 | 3.92                     | 179.77                       | 218.79               |
| 2018 | 3.60                     | 181.47                       | 217.97               |
...
| Description                                                                 | Emission Reduction (tons of CO₂ annually) |
|-----------------------------------------------------------------------------|-------------------------------------------|
...
|---------|---------|---------|
| ![SDG 1](https://via.placeholder.com/15/FF0000/000000?text=+) | ThaiBev Unites to Fight the Cold | Reduce the number of people affected by severe weather and natural disasters by more than 200,000 people |
| ![SDG 2](https://via.placeholder.com/15/FF0000/000000?text=+) | ThaiBev Helps Create a Model "Sammachip Sudstricct" (Ethical Career Community) | Campaign to manage agriculture sustainably by helping over 50 farmers (302 households) and creating an average income of 11,356 baht/household/year |
| ![SDG 3](https://via.placeholder.com/15/FF0000/000000?text=+) | Public health programs | In 2018, ThaiBev supported medical research and equipment and other basic health needs with over 50 million baht |
| ![SDG 4](https://via.placeholder.com/15/FF0000/000000?text=+) | Scholarship Program<br>Princess of Naradhiwas Rajanagarindra Teachers Project<br>Beta Young Entrepreneur<br>A Good Community with a Smile | In 2018, ThaiBev gave 1,177 scholarships from primary to tertiary level as well as occupational training valued at over 10 million baht to students and teachers in remote areas around the country<br>Over 2,000 children developed skills in sports, music and art<br>Added 87 qualified teachers, especially in rural areas |

# UN SDGs and Projects

| UN SDGs | Project | Measure |
|---------|---------|---------|
| ![SDG 8](https://via.placeholder.com/15/ff0000/000000?text=+) | - CONNEXT ED<br>- Beta Young Entrepreneur<br>- Sports Development<br>- Pracharath Rak Samakkee Project | - Over 70,000 children and youth received vocational training to promote better income-earning opportunities for themselves and their families<br>- 68 young entrepreneurs trained in the Beta Young project, with 2 becoming ThaiBev employees<br>- Supported over 800 professional athletes<br>- Since starting the Pracharath program, over 350 communities nationwide increased income from community tourism, with a total income value of 42 million baht |
| ![SDG 10](https://via.placeholder.com/15/ff0000/000000?text=+) | Pracharath Rak Samakkee Project | - Over 60,000 poor households had their income increased to exceed the poverty line |
| ![SDG 13](https://via.placeholder.com/15/ff0000/000000?text=+) | Seminar on C asean Sustainable Development Forum & Transforming Asia Pacific: Innovative Solutions, Circular Economy and Low Carbon Lifestyles | - Increased awareness and cooperation between 7 countries in the effort to find ways to reduce climate change |
| ![SDG 15](https://via.placeholder.com/15/ff0000/000000?text=+) | - The project of Hearts on Forestation under the King Initiatives<br>- Joining Forces for the Recovery of Nature in the Environment (Sirindhorn Reforestation Project)<br>- Cooperation with Huai Hong Khrai Centre | - Promoted sustainable management of all kinds of forest, reduced deforestation, revived encroached forests and reforested over 200 rai by planting 46,133 more trees (40,000 mangrove)<br>- Joining Forces for the Recovery of Nature in the Environment (Sirindhorn Reforestation Project) planted 6,133 trees |
| ![SDG 17](https://via.placeholder.com/15/ff0000/000000?text=+) | Pracharath Rak Samakkee Project | - Promoted cooperation between the state, private sector, civil society, academia and the public to establish Pracharath social enterprises in 77 provinces with an investment value of 337 million baht |
...
- **500 million baht** to operate projects covering 5 main categories:
...
### Note
- "Operations" refers to those assessing projects which may impact communities within the framework of a factory, operating across the country (29 premises).
...
ThaiBev is actively involved in providing assistance and supporting government operations to help people affected by cold weather. The initiative, "ThaiBev Unites to Fight the Cold Year 19," aims to distribute 200,000 green blankets annually to areas impacted by cold weather in 15 provinces of North and Northeast Thailand. These blankets symbolize warmth and support for those in need.

### Key Points:

- **Target Areas**: Focus on remote areas where people lack sufficient warm clothing, especially those in high mountain regions with difficult access.
- **Collaboration**: ThaiBev collaborates with the Department of Disaster Prevention and Mitigation of the Interior Ministry to gather data on affected populations.
- **Distribution**: Blankets are distributed every November, before the cold season, with 3.8 million blankets provided over 19 years across 45 provinces and 578 districts.
- **Additional Support**: Includes health checkups, mobile medical teams, music, sport, and art programs for children, along with educational equipment and scholarships for schools in need.
...
Thongchai expresses gratitude for ThaiBev's program, highlighting the importance of the initiative in the community. He appreciates the provision of blankets and educational support, hoping for continued efforts in the future.
...
# Program of Cooperation between the Huai Hong Khrai Centre and ThaiBev

## Reviving the Forest and Improving Quality of Life in Ban Nam Poon, Nam Phang District and Ban Sri Na Pan, Reuang District, Nan Province

To help protect headwaters, preserve the forest, and improve local residents’ quality of life, ThaiBev collaborated with the Huai Hong Khrai Royal Development Study Centre of HRH Princess Maha Chakri Sirindhorn. This initiative began on 2 April 2015, marking the 5th Cycle Anniversary of Her Royal Highness. The program aimed to replicate the successful Royal development strategy from Chiang Mai, implemented by the Huai Hong Khrai Centre at Doi Saket, and adapt it to Nan province.

### Goals and Implementation

- **Objective**: Revive the watershed and help villagers become self-reliant with sustainable economic and environmental practices.
- **Target Areas**: Ban Nam Poon and Ban Sri Na Pan.
- **Approach**: Shared sustainable development practices with the villages, intending to create a learning center for other communities.

### Outcomes

- **Training and Resources**: In 2017, 150 residents received training and raw materials for rearing livestock and crops for daily consumption, reducing household expenses.
- **Economic Impact**: By 2018, studies showed that these communities increased their incomes by 150-220% through raising livestock. 

The initiative focused on using livestock not needed for villagers’ consumption to yield high-quality products that could be sold by farmers.
...
1. **One Tambon One Good Occupation Project** was emphasized and expanded to create model projects around the factories and other areas, with the aim of increasing communities’ income by at least 10 percent by 2019.
...
4. **Huai Hong Khrai Center Project**
...
The government’s Pracharath policy aims to coordinate cooperation with all sectors to solve problems and find ways to build a better future for Thailand. ThaiBev has become head of the Private Sector Working Group in the Working Group of the Local Economic Development Pracharath Policy. This group has the key target of creating new income for communities to improve their quality of life. The work is completed through the combined efforts of five sectors: the government sector, the private sector, the civil society sector, the academic sector, and the general public. Together, they drive local economies to develop a whole system from upstream to midstream to downstream, with an emphasis on three areas – Agriculture, Processing, and Community-based Tourism – and they strive to build a network of PRS social enterprise companies that extends all over the country.

To drive the work efficiently and to achieve concrete results as well as long-term continuity, the Working Group has established social enterprises under the name Pracharath Rak Sammākhī or PRS in every province and has established PRS Social Enterprise (Thailand) Co., Ltd. as a coordinating entity between the various sectors around the country. All of the 77 PRS social enterprise companies were established in 2016.

Throughout 2018, 76 PRS Social Enterprise companies developed community businesses around the country via 428 projects in three groups – Agriculture (29%), Processing (52%), and Community-based Tourism (19%) – creating community income for 35,346 households worth over 172 million baht.
...
- **Practical Seminar**: Over 400 pakaoma weaving communities across Thailand participated in a seminar to enhance production techniques and business management, fostering networking and collaboration.

- **Empowering the Young Generation**: 
  - **Finding the Heirs of Thai Pakaoma**: A program training young people in weaving, supporting 15 locations nationwide.
  - **Nava-atalak Design Contest**: An innovative identity contest with 260 entries in fashion, home textiles, and patterns.

- **Connecting to Markets**: Promoting hand-woven pakaoma products through collaborations with designers, booths, and fashion catalogs.

## Sapai Sainaew Project (Local Cloth for Bags and Straps)

- **Objective**: Assist young people in Northern Thailand (Chiang Mai, Chiang Rai, Phrae, Nan, Lampang, Lamphun) to add value to local cloths.
- **Support**: Backed by the Thailand Textile Institute (THTI) and designers to create "Vaam" shoulder bags.
- **Outcome**: Generated income for 959 community members, totaling over 2 million baht in five months.
...
- **Hospital Food Safety Project**: 
  - PRS Social Enterprise has signed an MOU with the Ministry of Public Health, Ministry of the Interior, Ministry of Commerce, Ministry of Agriculture and Cooperatives, and the Community Organizations Development Institute.
  - The aim is to encourage the production and consumption of safe food by linking producers of safe fruits and vegetables with hospitals nationwide.
  - PRS social enterprises in each province will manage production plans and develop standards for community farmers.
  - In 2018, communities from 20 provinces joined the project, earning 15 million baht.

- **Creating online sales channels**: 
  - PRS Social Enterprise has partnered with telecommunications and online marketing companies to create outlets and develop online sales methods.
  - Products are displayed on the Farm Suk app and Lazada online marketplace.
  - Catalogs of community products are available on the company’s online channels, featuring 400 SKUs from 112 communities in 53 provinces.

- **Cheunjai Thailand TV Program**: 
  - ThaiBev has collaborated with PRS Social Enterprise and Amarin Television to promote community-based tourism.
  - The program, broadcast on Amarin TV HD channel 34, covers 94 communities in 62 provinces.
  - Publicity from the program has generated over 30 million baht for local communities.

- **Making connections between provinces**: 
  - This initiative aims to facilitate exchanges, find outlets for overstocked goods, and solve production surpluses.
  - In 2018, markets were found for various products like pineapples, garlic, longan, fresh chilies, and lychees across different provinces.
  - PRS Social Enterprise found new marketing outlets that generated an additional income of 30 million baht.

# Disseminating Knowledge

- **"Technology Outreach to Cure Poverty" (Using Science to Help the Poor):** ThaiBev and PRS Social Enterprise have joined the Ministry of Science and Technology to distribute ready-to-use technology to outlying communities through online channels, websites, and training programs. Focus is on upgrading local products and reducing production costs on OTOP Grade C and D products in 10 lower-income provinces: Mae Hong Son, Kalasin, Buriram, Nan, Nakhon Phanom, Narathiwat, Pattani, Chainat, Tak, and Amnat Charoen.

- **Diplomatic efforts:** PRS Social Enterprise representatives attended the High-Level Political Forum on Sustainable Development in 2017 (HLPF) at the United Nations headquarters in New York. The private sector team, led by Thapana Sirivadhanabhakdi, proposed the Voluntary National Reviews for local economies and PRS to promote the United Nations Sustainability Development Goals (SDGs), enhancing international recognition.

# Moving Forward

ThaiBev and PRS Social Enterprise (Thailand) Co., Ltd. will continue to support projects like the Thai Handicraft Pakaoma Project and safe food initiatives at hospitals. To ensure seamless cooperation in rural community development, ThaiBev has outlined future projects:

- Study various projects nationwide by analyzing results, identifying success factors, and risks to form a knowledge foundation for future initiatives.

- ThaiBev has established the Foundation for Developing Social Enterprises of Thailand to connect social enterprises in the PRS network and other networks, enhancing collaboration and sharing useful knowledge.

- Establish social enterprises in local areas interested in sustainable community development. Expanding social enterprises' workspace allows more communities to receive assistance.
...
- **Thai Handicraft Pakaoma Project** assisted more than 400 communities, producing young generations to handwoven pakaoma in 15 communities nationwide.  
  - Income generated: 30 million baht

- **Sapai Sainaew Project** (locally produced cloth for bags and straps) created income of more than 2 million baht for 959 people during a 5-month period in the communities involved.

- **Cheunja Thailand Program** publicized 94 tourism destinations for communities in 62 provinces, creating income of more than 30 million baht.
...
# Leadership for Sustainable Education Development (Connexx ED)

ThaiBev joined the Ministry of Education and 12 private sector businesses for Pracharath Policy’s Basic Education and Leadership Development Project for students to experiment with business practices. This initiative helps students manage and realize the value of money, encouraging them to learn about household accounting, costs, and profits. The project uses a "child-centered" learning process to help students understand basic business concepts.

The project has been coordinated for two years with 27 partner universities, educating 76,325 students from 292 schools in 47 provinces. It covers money management and basic business service skills. Students can further develop their knowledge by participating in the project, with 292 business project trials under the supervision of experts from partner universities, under the slogan "Help the Young". ThaiBev provides initial funding for these projects, encouraging students to apply their knowledge and skills to real-life experiences, taking on the role of entrepreneur. The company has also cooperated with the Department of Community Development to launch a scholarship competition—the 2nd OTOP JUNIOR contest, awarding more than 500,000 baht to winners.

The project promotes knowledge needed for accounting and business, and develops leadership and teamwork skills that benefit students in their daily lives and future careers.

## Suphatra Chuichai and Naranya Limcharoen

- **School**: Wat Krathum School (Somprachasan), Chachoengsao Province
- **Business Project**: "Thong Muan Junior has 9 Flavors"
- **Achievement**: 1st prize honor from OTOP Junior project contest

Through the project, they learned about accounting, profit and loss statements, and income. Keeping notes after making Thong Muan coconut crispy rolls helped them see profits clearly. They save money in a piggy bank, learning the value of money and the effort required to earn it. They are proud to make money while studying.

## Phithak Chimsut

- **Role**: Teacher responsible for Pracharath’s School Project at Ban San Pa Rai School in Tak Province.

This project has focused on creating vocational skills in schools, integrating the project into each school’s curriculum.

## Opportunities for Special Children

ThaiBev has supported seven schools for children with special needs in six provinces, including Chiang Mai, Chiang Rai, Nakhon Sawan, Phitsanulok, Ubon Ratchathani, and Songkhla. The initiative aims to provide education to children with intellectual disabilities and multiple disabilities. ThaiBev collaborates with partner universities in the area as consultants and project facilitators.

### Key Initiatives:
- **Low-relief Art from Recycled Paper Project**: 
  - ThaiBev has donated money and resources to support this project.
  - The project helps children improve concentration, fine motor skills, and emotional development.
  - It enables children to focus better and make independent decisions.

## Mulberry Leaf Tea Project, Ban Nong Kradon School, Nakhon Pathom Province

ThaiBev has partnered with the Faculty of Management Sciences at Nakhon Pathom Rajabhat University to utilize leftover mulberry juice in producing mulberry leaf tea. This project is part of the OTOP initiative and includes:

- **Consulting Services**: 
  - Assistance in product development, production processes, marketing, distribution, and after-sales services.

- **Student Involvement**:
  - 150 students (primary grade 4 to secondary grade 3) formed a club to manage activities.
  - Students learn business principles, including cost and profit calculation and fund management.
  - They add value to the product by using the identity of the province as a hallmark of the product design.

# Partnership School Project

- **Leadership Skills**: Students practice leadership and present during business activities.
- **Product Development**: Mulberry leaf tea products are sold at school and community stores, packaged with local landmark images and varied aromas.
- **Entrepreneurship**: The project encourages students to progress from OTOP Junior to Young OTOP, aiming to become self-sufficient entrepreneurs.

## ThaiBev's Involvement

ThaiBev collaborates with the Ministry of Education to launch the Partnership School Project, marking the first time private and civil sectors co-manage schools. The project aims to:

- Develop curricula and activities.
- Manage human resources.
- Set success guidelines.

### Goals

- Equip students with skills for successful lives and citizenship.
- Adapt to changing world contexts.

### Achievements

- Sponsored 19 schools, impacting over 10,000 students.
- Organized community initiatives.

## Activities

- **"Big Cleaning Day" at Ko Kha Kindergarten School, Lampang Province**: Led by Mr. Kajorn Bhirakit with over 70 Thai Beverage Logistics Co., Ltd. employees, involving local organizations and parents to maintain school cleanliness.

- **"Big Cleaning Day" at Tha Chang Wittayakhan School, Surat Thani Province**: Led by Ms. Oraparn Yuvanavon and Mr. Chanawat Narbweg, with ThaiBev employees improving school hygiene and infrastructure.

- **HRH Princess Srinagarindra Demonstration School, Chiang Mai**: Led by Mr. Prapoh Sabhavasu, sent teachers for training at the Huai Hong Khrai Royal Development Study Centre, focusing on hairstyling, cooking, and art.

# Princess of Naradhiwas Rajanagarindra Teachers Project

This project recognizes the sacrifices made by teachers working in remote areas. Teachers from three agencies—the Office of Non-Formal and Informal Education, the Border Police Headquarters, and the Office of the Basic Education Commission—are selected to be honored with the Princess of Naradhiwas Rajanagarindra Teacher Prize. So far, 87 teachers have been given this prestigious honor during a ten-year period. ThaiBev has sponsored the Princess of Naradhiwas Rajanagarindra Teacher Prize for the past six years with 1 million baht per year. The prizes are divided into two categories: the first is for new recipients, in the amount of 900,000 baht; and the second category is for teachers who have been recognized with the award in the past. The second award is in the amount of 100,000 baht for the continued implementation of the Quality of Life and Environment Project.
...
2. **Hairstyling**: The children can turn this skill into a career which can generate extra income and funding for their higher education. There is one student who is a boxer and lives in Muaythai Boxing Camp; he served as the boxing camp’s barber as well. He once cut the hair of a world champion boxer.
...
This project is based on the collaboration of three organizations: the Thai Chamber of Commerce, the University of the Thai Chamber of Commerce, and the Srivadhanabhakdi Foundation. Together these organizations are training a new generation of university students to be entrepreneurs, with a special focus on releasing their potential and promoting strong virtues, ethics, and social responsibility when doing business. The main activities are divided into two areas:
...
## Chaiwat Koisantisuk
*Beta Young #2 alumni, currently owns a security alarm system business*

Joining a UTCC Beta Dummy Business is a big plus that can definitely provide you useful experience to apply to your business. At that time, it was the beginning of the dummy business, we faced many problems and had to solve them all. Some problems we were able to solve, others we could not. Finally, when we had to manage our own business, we felt like we had faced those problems before. So, it helped set quite a stable foundation for our own business. We got to learn about all these systems, stocking, accounting, and store management, marketing, organizing various promotions, and customer service. We integrated these experiences we got from the dummy business into our own business.

## Rachata Iamsongkram
*Beta Young #3 alumni, currently owns Jae’s Accessories store*
...
- **Partnership School Project** supported **19 schools** and developed over **10,000 students**.
...
- Provided medical equipment to the Ministry of Public Health to support various projects. ThaiBev sponsored the Annual Non-Communicable Disease Conference (NCD Forum) in 2016 and 2017, allocating one million baht per year. Donated medical equipment to hospitals under the Ministry of Public Health, including Chao Praya Aphaiphubet Hospital, Pattani Hospital, Phra Buddhachinaraj Hospital, Sampran Hospital in Nakhon Pathom Province, Maharaj Hospital in Nakhon Sri Thammarat Province, and Cha Uat Hospital in Nakhon Sri Thammarat Province.

- Donated money to Phromburi Hospital in Singburi Province. ThaiBev also joined the official opening of the 99th Anniversary of Phra Thammaprayabodi (Thaworn Charoenphanit) building, for activities related to patients and the public.
...
| Vascular Access For Hemodialysis as dedication to Princess Maha Chakri  | 83         | patients |
...
| Sport       | Project                                                                 | Operation                                                                 | Duration               | Number of participants/year |
|-------------|-------------------------------------------------------------------------|---------------------------------------------------------------------------|------------------------|-----------------------------|
...
Sport is a tool that everyone can relate to. It can be used to create good people in society. In recognition of the importance of sport, ThaiBev’s sport projects for youth were established and have been growing continuously. We can now start seeing the results.
...
Chang Football Community is a project established to build a football network in local areas that lack opportunities. It aims to create five strong football communities across the country. ThaiBev hopes to establish a basis for football knowledge in accordance with international standards and provide necessary equipment for athletic programs systematically. These communities have been receiving development assistance for five years.
...
- **Achievement in 2018**: Started to see a potential to reduce tensions experienced by juveniles
...
| Received opportunities to improve skills      | 400              |
| Received opportunities to improve skills      | 1,500            |
| Received opportunities to improve skills      | 1,000            |
| Received opportunities to improve skills      | 150              |
| Entered the professional/national level       | 150              |
| Became professional footballers               | 17               |
| Became professionals in national leagues      | 100              |
| Became professionals in national tournaments  | 20               |
...
The Bangkok Art and Culture Centre (BACC) is an urban art gallery focused on providing knowledge about art and culture to children and young people in Bangkok and its surroundings. Over its 10 years of operation, ThaiBev has supported BACC, recognizing the importance of maintaining and disseminating art and culture. As the first sponsor of various contemporary art exhibitions at BACC, ThaiBev emphasizes the value of passing on modern art and culture to new generations, contributing to sustainable societal development.
...
ThaiBev values the promotion of art and culture, particularly music. Through sponsorship, ThaiBev has supported Ekachai Jearakul in international music competitions, enhancing Thailand's classical music presence globally. ThaiBev also supports projects like recording the compositions of King Bhumibol Adulyadej and sponsoring concerts, providing opportunities for growth and contribution in the arts.
...
- **Royal Patronage for Photography Exhibition**: His Majesty the King granted permission for the Photographers’ Association of Thailand to exhibit 200 photographs by His Majesty the late King Bhumibol Adulyadej at the Bangkok Art and Culture Centre. The photographs were also published in a book by the Sirivadhanabhakdi Foundation and ThaiBev.

- **Exhibition by HRH Princess Maha Chakri Sirindhorn**: Since 2006, an exhibition of photographs by HRH Princess Maha Chakri Sirindhorn has been held at the Bangkok Art and Culture Centre. In 2017, it was titled "Kavauvarapaha."

- **Support for Cultural Memorials**: ThaiBev supported the construction of the "Nyanasamvara Thailand–Japan Memorial" and installed a statue of His Holiness the Supreme Patriarch of Thailand at Wat Pa Buddharangsee in Tokyo.

- **"Love to Dispel Coldness" Event**: This event was a tribute to His Majesty the King, promoting traditional ways of life. Products from the "Pracharat Rak Samakkee Project" were sold, and the "Chayaantikorn" Picture Studio offered retro-photography services.

- **Great Songkran Ritual**: Conducted by His Majesty the King, this event promoted Thai customs. The "Chayaantikorn" Picture Studio provided retro-photography services with a Songkran theme.

![Exhibition Opening](https://example.com/image1.jpg)
...
![Kavauvarapaha Exhibition](https://example.com/image2.jpg)
*Her Royal Highness Princess Maha Chakri Sirindhorn officially opened an exhibition of photographs titled "Kavauvarapaha" at Bangkok Art and Culture Centre on December 11, 2017.*

# Art and Culture Historical Book Projects

- **Celebrating the National Glass Plate Negative Recognized as UNESCO Memory of the World**: A book jointly organized by the National Archives of Thailand and the Sirivadhanabhakdi Foundation, marking the registration of ancient photographs and glass plate negatives collection "The Vajirayana Library" as UNESCO Memory of the World 2017.
...
- **Celebrating the National Glass Plate Negatives Registered as UNESCO Memory of the World**: A joint project of the National Archives and the Sirivadhanabhakdi Foundation on the occasion of the Vajirayan Royal Library of plate photographs being registered as a UNESCO Memory of the World in 2017.
- **Exhibition on the Front Palace**: Part of the program to study the former Front Palace with the aid of technology by the Fine Arts Department in cooperation with the National Archives and the Phra Ratchanives Marukkataiwan Foundation.
...
- **Continuous support** for the Sukree Charoensuk Foundation since 2010.

## Sustainability Report 2018

- **Annual Support for SuanPlu Chorus Group**
  - In 2018, the group represented Thailand at the 2nd Corfu International Festival & Choir in Corfu, Greece.
  - Achieved maximum points in all three parts of the competition.
  - Recognized with a Gold Diploma and as the "Supreme Winner".

- **Support for Research**
  - Focus on "The Musical Genius of His Majesty the King Bhumibol Adulyadej: A Case Study of the Recording of 41 Royal Compositions with Lyrics for Choir."
  - Conducted by Assoc Prof Dr Manasikarn Laowanit.
  - Celebrates and disseminates the musical accomplishments of the late King Bhumibol Adulyadej.

- **Support for Princess Galyani Vadhana Institute of Music**
  - Facilitates opportunities to perform at different events or cooperate in special projects.

- **Budget Support for Luang Pradit Phairoh Foundation**
  - Supports the expansion of the project Friends of Music.
  - Creates a network of individuals in Thai music to support community activities globally.

## Support for the "Friends of Music" Project

- **Location**: Wat Thang Klang School in Bang Pahun, Ayutthaya province.
- **Objective**: Assess the potential to teach music to children using musical instruments, music teachers, and media such as books and multimedia.
- **Activities**: Designed for the school and community to highlight the role of music in education.

### Contributions and Support

1. **Donations**:
   - 100 piang or flutes and a group of eight long drums with other percussion instruments.
   - Used for cultural and performance-related events like the Buddhist Lent Candle Procession or Mother’s Day.

2. **Partnership Operations**:
   - Collaboration with schools to survey and advise Wat Chulamae School in Ayutthaya province.
   - Plans for teaching Thai music at schools lacking a Thai music teacher are being prepared.

3. **Expert Advice**:
   - Provided to Bangkok at Leu Amnat kindergarten School (Ban Cheuan) in Amnat Charoen Province.
   - Focus on promoting knowledge and occupational understanding.

4. **Central Resource Role**:
   - Organizing musical activities, providing venues, coordination, and publicity.
   - Arranging exhibitions and printing souvenir programs for the public at no expense at the Reuan Banleng of the Luang Pradit Phairoh (Sorn Silapabanleng) Foundation.

# Enhancing Art and Culture Initiatives in the Creative Economy

![Art Exhibition](image-link)

A winner of the 7th White Elephant Fine Arts Contest titled "Farmers’ Children" by Boonman Sa-sud under the heading, "Inspiration from Everyone for a Sustainable Community."
...
- **White Elephant Fine Arts Contest**: 
  - Encourages realistic and figurative art.
  - Supports artists with a dedicated stage to showcase abilities.
  - Top prize is 1 million baht.
  - 2018 theme: "Enjoyment of ritual."

- **Chayaintikorn Picture Studio**:
  - Opened at the "Love to Dispel Coldness" event in 2018.
  - Provided retro-photography services.
  - Popular and widely discussed.
  - Income donated for public benefit.

- **Water Festival**:
  - Fosters Thai-style tourism.
  - Promotes Songkran custom and modern Thai identity.
  - Part of cultural heritage.

- **River Festival**:
  - Conserves cultural tourism.
  - Highlights Thai ways of life and customs.
  - Attracts tourists worldwide, stimulating further visits.

# Bangkok Art Biennale

## C asean Consonant

- **Concept**: Bringing the universal language of music to make connections and create unity in a region with diverse cultures, languages, religions, and politics.
- **Objective**: To conserve cultural heritage and disseminate it to young people through traditional musical instruments from ASEAN countries.
- **Event**: Invited to the Bangkok Art Biennale (BAB 2018) for cultural exchange, featuring performances by young musicians from 10 ASEAN countries.

## Bangkok Art Biennale: BAB

- **Overview**: International modern art festivals held globally, showcasing leading artists under the concept "Beyond Bliss." The term "Biennale" means "once every two years."
- **Significance**: Held in Bangkok, a city known for its diversity in religion, ethnicity, and community lifestyles, reflecting the Thai identity.
- **Impact**: Enhanced Thailand's image for cultural tourism, attracting artists and tourists to Bangkok as a modern art destination.
- **Opportunities**: Provided a platform for young Thai artists to develop skills and human resources in creative fields.
- **Event Details**: 
  - **Duration**: 19 October 2018 to 3 February 2019.
  - **Venues**: Historical buildings, riverside locations, and modern sites like One Bangkok.
  - **Participation**: 75 international artists from 33 countries, with over 200 artworks curated by an international team.

## Featured Artworks

- **Aurele (France)**: "Lost Dog" or "Ma Long" (2018) - Gold leaf on fiberglass, height 5.90 m.
- **Yayoi Kusama (Japan)**: "14 Pumpkins" (2017) - Inflatable pumpkins, fabric, 14 pieces.
...
Bangkok Art Biennale 2018 was the first of its kind in Bangkok, and came about through substantial coordination between the state and the private sector. The Ministry of Tourism and Sports, the Bangkok Metropolitan Administration, the Tourism Authority of Thailand, various foreign embassies in Thailand, and partners sponsored this world-class art event, which is to be held every two years.

For the Bangkok Art Biennale 2018, the aim was to make Bangkok a global center for modern art and to stimulate the tourism industry, generating income for all, from the community of art lovers to the local economy. The Ministry of Tourism and Sports set an income target from tourism in 2018 of 3 trillion baht. Throughout the four-month duration, the event attracted tourists, art collectors, curators, artists, and the rest of the art scene from all over the world, representing massive economic value. The expectation is for the Biennale to continue being an important part of helping the tourism industry meet revenue targets from quality tourism, enhancing the country's tourism image, and spreading Thai art and culture globally.

Besides tourism support, there was an activity for art lovers in Thailand called "DEK BAB." This opportunity allowed volunteers, including students and members of the public, to participate in the Biennale, acting as ambassadors and connecting artists with viewers. Over 700 volunteers gained knowledge, experience, and understanding of art, sharing it with others.
...
| **Activities of the Sukree Charoensuk Foundation. 7 activities comprise:** |                                        |
| 1. Music Therapy at the Child Abuse Care Center, Phetchaburi province    | Participants: 30<br>Beneficiaries: 500 |
| 2. Using Music to Develop Young People Project at the Ban Pranburi Child and Youth Training Center | Participants: 50<br>Beneficiaries: 200 |
| 3. Pilot Band for Children and Youth, the Flute and Recorder Group of Wat Suwannaram School | Participants: 80<br>Beneficiaries: 500 |
| 4. Project for Giving Children A Good Background in Local Music at Wat Lad Sai School | Participants: 70<br>Students from nearby schools: 200<br>Beneficiaries: 500 |
| 5. Research Project in the Study of Musical Gifts                        | Participants: 120<br>Beneficiaries: 1,500 |
| 6. "A Good Communities with a Smile" Project                             | Participants: 500<br>Beneficiaries: 5,000 |
| 7. "Phalang Phan Kamlang Jai" Project of Classical Music for Society     | Participants: 250<br>Beneficiaries: 1,500 |

# Performance Summary

## Economic Performance

| Indicators | Performance | Unit | 2014 | 2015 | 2016 | 2017 | 2018 |
|------------|-------------|------|------|------|------|------|------|
| **GRI 201-1 Economic performance** | | | | | | | |
| 1. Total Income | | Million Baht | 162,790 | 173,419 | 139,887 | 191,205 | 190,697 | 232,598 |
...
| Total (purchase value) | | Percent | 91 | 92 | 87 | 97 | 97 | 97 |
| Alcoholic beverages (number of suppliers) | | Percent | 98 | 97 | 97 | 97 | 95 | 95 |
| Alcoholic beverages (purchase value) | | Percent | 87 | 86 | 80 | 80 | 85 | 92 |
| Non-alcoholic beverages (number of suppliers) | | Percent | 99 | 99 | 99 | 99 | 98 | 97 |
| Non-alcoholic beverages (purchase value) | | Percent | 98 | 99 | 98 | 98 | 99 | 91 |

## Environmental Performance

| Indicators | Material Aspects | Unit | 2014 | 2015 | 2016 | 2017 | 2018 |
|------------|------------------|------|------|------|------|------|------|
| **GRI 302-1 Energy consumption within the organization** | | | | | | | |
| Total energy consumption within the organization | | MJ | 6,062,992,998 | 6,224,230,629 | 6,525,654,751 | 6,499,783,690 | 6,192,775,688 |
| Total fuel consumption within the organization from non-renewable sources | | MJ | 4,063,977,026 | 4,153,109,374 | 4,368,963,332 | 4,168,818,353 | 4,070,618,040 |
| - Fuel oil | | MJ | 1,769,249,892 | 1,697,261,693 | 1,784,765,661 | 1,817,833,830 | 1,364,409,734 |
| - Natural gas | | MJ | 217,429,005 | 250,190,521 | 262,852,131 | 112,984,871 | 311,120,573 |
| - Ethanol | | MJ | 100,576,544 | 15,220,029 | 787,146 | 0 | 0 |
| - Reused oil | | MJ | 0 | 0 | 0 | 0 | 64,885,721 |
| - Gasoline | | MJ | 4,233,575 | 4,699,564 | 5,126,389 | 4,584,687 | 4,303,097 |
| - Diesel | | MJ | 1,162,228,284 | 1,169,709,879 | 1,149,569,325 | 1,088,820,492 | 918,584,581 |
| - Bituminous Coal | | MJ | 741,408,997 | 934,377,042 | 1,067,711,284 | 1,040,995,429 | 1,300,044,619 |

# Indicators and Material Aspects

| Indicators | Material Aspects | Unit | 2014 | 2015 | 2016 | 2017 | 2018 |
|------------|------------------|------|------|------|------|------|------|
| - LPG | | MJ | 67,850,750 | 81,650,547 | 98,149,857 | 103,399,044 | 107,269,714 |
| Total fuel consumption within the organization from renewable sources | | MJ | 1,100,958,369 | 1,126,326,413 | 1,235,179,077 | 1,900,737,807 | 1,072,622,936 |
...
| - Solar energy | | MJ | 0 | 0 | 0 | 456 | 442,337 |
...
| Water Withdrawal by Source | Unit | 2014 | 2015 | 2016 | 2017 | 2018 |
|----------------------------|------|------|------|------|------|------|
| Total volume of water withdrawn | Cubic Meter | 19,575,729 | 20,616,340 | 23,516,238 | 24,842,270 | 19,883,174 |
...
| Indicators          | Material Aspects                          | Unit              | 2014(1)     | 2015(1)     | 2016(2)     | 2017(3)     | 2018(3)     |
|---------------------|-------------------------------------------|-------------------|-------------|-------------|-------------|-------------|-------------|
...
|                     | Direct (Scope 1) GHG emissions (4)        | Metric tons CO₂e  | 604,159     | 699,876     | 654,995     | 603,059     | 596,692     |
...
|                     | GHG emissions intensity (Beverage)        | kg CO₂e / kg      | 30.68       | 31.82       | 26.32       | 26.03       | 25.84       |
|                     | - GHG emissions intensity (Distillery)    | kg CO₂e / kg      | 61.93       | 61.13       | 59.44       | 55.69       | 59.10       |
|                     | - GHG emissions intensity (Brewery)       | kg CO₂e / kg      | 17.20       | 16.83       | 17.04       | 18.20       | 19.46       |
|                     | - GHG emissions intensity (Oish)          | kg CO₂e / kg      | 16.05       | 13.77       | 12.39       | 12.31       | 11.99       |
|                     | - GHG emissions intensity (Sermsuk)       | kg CO₂e / kg      | 4.97        | 4.89        | 4.22        | 5.12        | 4.39        |
|                     | GHG emissions intensity (Food)            | kg CO₂e / kg      | N/A         | N/A         | N/A         | 1.12        | 2.56        |
...
|                     | Quality of the water discharges (15)      |                   |             |             |             |             |             |
...
(1) Data for 2014 and 2015 are restated.  
(2) Data for 2016 are restated.  
(3) Data for 2017 and 2018 are restated.  
(4) Includes biogenic CO₂ emissions.  
(15) Quality of water discharges is measured in terms of pH, BOD, COD, TDS, and TSS.
...
| Total weight of waste (b)(c) | Metric tons | 91,125 | 53,117 | 79,468 | 65,645 | 13,473 |
...
- 1. In 2014 – 2015, ThaiBev reported the efficiency of its environmental performance that covers a 12-month period from January to December.
- 2. In 2016, ThaiBev reported the efficiency of its environmental performance that covers the period from October 2015 to September 2016.
...
|               | ThaiBev Group                                         |       |         |          |         |          |         |          |         |          |         |          |
|               | Total                                                 | Persons| 23,588  | 14,791   | 24,057  | 15,278   | 24,710  | 15,992   | 24,821  | 16,546   | 24,538  | 17,013   |
...
|               |                                                       | Persons| 1,621   | 1,128    | 1,514   | 1,010    | 1,540   | 1,363    | 1,707   | 931      | 1,558   | 1,696    |
|               | Under 30 years                                        | Percent| 46      | 56       | 46      | 57       | 45      | 63       | 44      | 54       | 46      | 68       |
...
|               | Executive level 13-15 (by gender)                     | avr. training hour/head/yr.| N/A     | 6.17     | 9.50    | 40.45    | 43.02   | 31.80   | 28.35    | 46.42   | 63.39    |
...
|-----------|------------------|------|------|------|------|------|------|
|           |                  |      | Male | Female | Male | Female | Male | Female | Male | Female | Male | Female |
| Senior officers level 4-7 (by gender) | avr. training hour/head/yr. | N/A | 17.25 | 16.71 | 21.24 | 20.40 | 38.94 | 39.36 | 29.95 | 41.86 |
| Total officers | avr. training hour/head/yr. | N/A | 8.72 | 10.91 | 10.19 | 5.09 |
| Officers level 1-3 (by gender) | avr. training hour/head/yr. | N/A | 18.28 | 8.68 | 9.21 | 15.93 | 10.00 | 10.69 | 4.77 | 5.96 |
...
| Total ThaiBev group | Unit | 2014 | 2015 | 2016 | 2017 | 2018 |
|---------------------|------|------|------|------|------|------|
| Total employees | Persons | 29,723 | 29,870 | 30,653 | 31,325 | 31,549 |
|                   | Percent | 100 | 100 | 100 | 100 | 100 |
| Total employees level 1-5, Senior Executive | Persons | 55 | 63 | 73 | 60 | 60 |
|                   | Percent | 100 | 100 | 100 | 100 | 100 |
| Total employees level 1-5, Senior Executive (by gender) | Persons | 45 | 10 | 50 | 13 | 59 | 14 | 46 | 14 | 45 | 15 |
|                   | Percent | 100 | 100 | 100 | 100 | 100 | 100 | 100 | 100 | 100 | 100 |
| Total employees level 8-14 | Persons | 1,452 | 1,812 | 1,956 | 2,047 | 2,266 |
|                   | Percent | 100 | 100 | 100 | 100 | 100 |
| Total employees level 8-14 (by gender) | Persons | 854 | 598 | 1,076 | 736 | 1,159 | 797 | 1,205 | 842 | 1,330 | 936 |
|                   | Percent | 100 | 100 | 100 | 100 | 100 | 100 | 100 | 100 | 100 | 100 |
| Total employees level 1-7 | Persons | 28,216 | 27,995 | 28,624 | 29,218 | 29,223 |
|                   | Percent | 100 | 100 | 100 | 100 | 100 |
| Total employees level 1-7 (by gender) | Persons | 19,015 | 9,201 | 18,832 | 9,163 | 19,109 | 9,515 | 19,328 | 9,890 | 19,095 | 10,128 |
|                   | Percent | 100 | 100 | 100 | 100 | 100 | 100 | 100 | 100 | 100 | 100 |
...
| Operations with local community engagement | Percent | 100 | 100 | 100 |
| Operations with impact assessments | Percent | 81 | 100 | 100 | 100 |
...
5. Headquarters are Cyber World, TCC Surawong, Park Venture Building, Lao Peng Nguan Building 1, East Water Building, Sangsom Building at Phaholyothin, Sangsom Building at Vibhavadi and Thapthara Complex.
...
7. In 2014-2017, local community engagement, impact assessments, and development programs performance report 1) Percentage of implemented areas/provinces 2) Percentage of areas surrounding factories 3) Percentage of sale target areas.
...
|----------------|----------------------------------------------|---------------|------|------|------|------|------|
| **GRI INDICATORS** |                                              |               |      |      |      |      |      |
| GRI 403-1      | Number of Health and Safety (H&S) Committee  | %             | 3%   | 3%   | 3%   | 4%   | 2%   |
...
| **DJSI INDICATORS** | | | | | | | |
| DJSI 3.6.2 | Lost Time Injury Frequency Rate (LTIFR) - Contractors working on-site | Per 1,000,000 hrs. | 2.31 | 0.67 | 1.43 | 1.22 | 0.89 |
| DJSI 3.6.3 | Lost Time Injury Frequency Rate (LTIFR) - Employee | Per 1,000,000 hrs. | 4.06 | 3.48 | 3.16 | 1.90 | 1.36 |
| DJSI 3.6.4 | Occupational Illness Frequency Rate (OIFR) - Employee | Per 1,000,000 hrs. | 0.04 | 0.00 | 0.00 | 0.06 | 0.00 |
...
- **Checking Governance Structure**: Verified ThaiBev's adherence to GRI’s Universal Standard for governance disclosure, confirming sustainable development as a senior management responsibility.
- **Auditing Data Management**: Ensured no significant errors in ThaiBev’s data management by reviewing data handling processes and speaking with key personnel.
- **Site Visits**: Conducted visits to assess data management systems and data reliability at:
...
*Note: LRQA did not verify original data sources or assess data accuracy and completeness.*

## Observations

Further observations and findings:

- **Inclusivity**: No key stakeholder groups were excluded from ThaiBev’s engagement process. Future engagements should include stakeholders like temporary workers.
- **Materiality**: ThaiBev uses its existing materiality assessment process, confirming alignment with sustainability strategy and vision 2020.
- **Responsiveness**: ThaiBev has policies for stakeholder concerns. Further implementation of these policies is needed for sustainable performance.
- **Reliability**: ThaiBev’s data management system is unchanged. Adoption of a QA/QC system is encouraged for improved data reliability and consistency.

## LRQA’s Competence and Independence

LRQA ensures qualified individuals conduct assessments, reviewed by senior management for rigor and transparency. This verification is the only work undertaken by LRQA for ThaiBev, maintaining independence.
...
22th Floor, Sirinrat Building, 338/876 Rama IV Road  
...
*This Assurance Statement is valid only when published with the Report to which it refers. It may only be reproduced in its entirety.*  
*Copyright © Lloyd’s Register Quality Assurance Limited, 2018.*
...
| GRI (Global Reporting Initiative)             | Internationally-accepted guidelines for reporting a company’s economic, social, and environmental performance.                                                                                               |
...
| GRI 102-13                           | Membership of associations                                                                              | Please refer to Thaibev's website: [Link](http://www.thaibev.com/en08/aboutus.aspx?sublv1gID=137) |                    |
| **Strategy**                         |                                                                                                         |                    |
...
| GRI 102-25                           | Conflicts of interest                                                                                   | Please refer to Thaibev’s Corporate Governance Report: [Link](http://www.thaibev.com/en08/aboutus.aspx?sublv1gID=139) |                    |
| GRI 102-28                           | Evaluating the highest governance body’s performance                                                    | Please refer to Thaibev’s Corporate Governance Report: [Link](http://www.thaibev.com/en08/aboutus.aspx?sublv1gID=139) |                    |
| GRI 102-30                           | Effectiveness of risk management processes                                                              | Please refer to Thaibev’s Corporate Governance Report: [Link](http://www.thaibev.com/en08/aboutus.aspx?sublv1gID=139) |                    |
...
| GRI 102-50                                   | Reporting period                                                                  | 10-11, 171-173     |                    |
| GRI 102-51                                   | Date of most recent report                                                        | 10-11, 171-173     |                    |
...
| GRI 303-3 | Water recycled and reused | 90-95, 168-171 | Yes |
| **GRI 305: EMISSIONS** | | |
...
| GRI 412-1                                         | Operations that have been subject to human rights reviews or impact assessments   | 58-83, [Link](http://www.sustainability.thaibev.com/en/employee_human_rights.php) |                    |
